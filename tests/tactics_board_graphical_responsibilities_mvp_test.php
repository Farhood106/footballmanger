...
$needles = [
    ...
    [$tacticModel, 'extractLineupPlayerIds'],
    [$tacticModel, 'normalizeResponsibilitiesForLineup'],
    ...
    [$squadController, 'مسئولیت‌های خارج از ترکیب اصلی حذف شدند'],
    [$tacticsView, 'tactics-pitch'],
    [$tacticsView, 'بورد گرافیکی تاکتیک'],
    [$tacticsView, 'مسئولیت‌های کلیدی تیم'],
    [$tacticsView, 'ابتدا ترکیب ۱۱ نفره را ذخیره کنید'],
    [$tacticsView, 'Score'],
    [$tacticsView, '⭐'],
